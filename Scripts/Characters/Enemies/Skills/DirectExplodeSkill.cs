...
{
    public class DirectExplodeSkill : IEnemySkill
    {
        public event Action EventSkillEnd;

        private DirectExplodeSkillData data;
        ...
        public void Initialize(DirectExplodeSkillData _data, Transform _firingPoint, BaseEnemy _owner)
        {
            data = _data;
            owner = _owner;
            ...
            projectilePool = new(data.ExplodePrefab);
        }
        ...
        private void Fire(bool isDirect)
        {
            ...
            var projectile = projectilePool.Rent(firingPoint.position + direction * 5, Quaternion.LookRotation(direction)) as ExplodeProjectile;
            projectile.Initialize(data.ExplodeData, direction, owner);
        }
    ...
    [Serializable]
    public class DirectExplodeSkillData
    {
        public ExplodeProjectile ExplodePrefab;
        public ExplodeProjectileData ExplodeData;
        public int Amount = 3;
